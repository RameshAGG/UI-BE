...
export class Casecare1745645044603 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "vendor_devices" ("id" SERIAL NOT NULL, "vendor_id" integer NOT NULL, "device_type" character varying NOT NULL, "device_id" character varying NOT NULL, "device_token" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by" character varying, "updated_by" character varying, "deletedAt" TIMESTAMP, "deletedBy" character varying, CONSTRAINT "PK_53ff791b1f96b580898dab0e845" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "sub_service_master" ("id" SERIAL NOT NULL, "service_id" integer NOT NULL, "name" character varying NOT NULL, "deletedAt" TIMESTAMP, "deletedBy" character varying, CONSTRAINT "PK_05b8c16a78a82966c21288aaf8c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "service_master" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_4699fed099e7f54e7fa16b89762" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "vendor_devices"`);
